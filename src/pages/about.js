...
export default () => (
    ...
    <p>Born and raised in Jackson Heights, Queens, to a family of Thai immigrants (hence the fun last name, which is spelled Laohakul, but pronounced more like Lao-ha-kun), I was taught to work hard and keep out of trouble. I listened to the wisdom of my parents, but I also learned to live a little more dangerously and a lot more passionately.</p>
    <br></br>
    <p>The dangerous:</p>
